...
import * as Account from '../../example/support/account.js';
import { store } from '../../example/support/account.js';
import { logins } from '../../example/support/account.js';
...
export async function sign(payload, key, alg, options = {}) {
  ...
  Object.assign(payload, p.profile);
